...
#define MISSING_RL_TILDE_EXPANSION 1
...
/* Automake 1.12 dropped support for building without prototypes */
#define PROTOTYPES 1
...
/* Define to allow zooming or refresh of volatile data. */
