...
! This module defines the KIND types of all the variables used in the
! code: 
! I4B, I2B and I1B for integer variables, SP and DP for real variables
! (and
! SPC and DPC for corresponding complex cases), and LGT for the default 
! logical type. This follows the convention used the Numerical Recipes
! for 
